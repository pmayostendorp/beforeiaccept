//If there are any issues with this file not working correctly, contact James or Nick. 

//There is a file named handlebars-1.0.0-rc.4.min_orig.js in the directory with this file that is 
//the original copy of this file. If there is an emergency and this file needs to be reverted, use 
//handlebars-1.0.0-rc.4.min_orig.js by changing it's name to handlebars-1.0.0-rc.4.min.js and 
//flushing the cache through Akamai.

//The condition was added to allow the Monterey Herald comics widget to work properly since 
