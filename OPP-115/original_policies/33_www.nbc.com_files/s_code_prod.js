...
s_linkInternalFilters="javascript:,nbcuni.com";

//var s_account="nbcudev";
var s_account="nbcuglobal,nbcucorporated,nbcunbcuniversalbu";
...
function s_doPlugins(s) {
	...
	s.prop7=s.eVar6=s.getQueryParam('s,q',':');  
    	s.prop7=s.eVar6.toLowerCase();
	...
	if(s.c_r('campaignname')){
	    ...
	    if(s.pageName){s.prop14=s.prop14 + s.pageName;}
	    else{s.prop14=s.prop14 + document.location;}
	}
	s.prop21 = s.getQueryParam("nlcid"); 
	s.prop22 = s.getQueryParam("affiliate");
	...
	if (s.campaign) {if (s.campaign.match('widget')){s.eVar45 = s.prop9;}} else {s.eVar45 = '';}
