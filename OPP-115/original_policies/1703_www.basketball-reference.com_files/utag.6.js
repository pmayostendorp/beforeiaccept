//tealium universal tag - utag.6 ut4.0.201308290013, Copyright 2013 Tealium.com Inc. All Rights Reserved.
var s_account="sportsyardbarkerprod";var s_analytics=s_gi(s_account);s_analytics.dynamicAccountSelection=false;s_analytics.dynamicAccountList="";s_analytics.trackDownloadLinks=true;s_analytics.trackExternalLinks=true;s_analytics.trackInlineStats=true;s_analytics.linkDownloadFileTypes="zip,exe,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx";s_analytics.linkInternalFilters="yardbarker.com,javascript:";s_analytics.linkLeaveQueryString=true;s_analytics.linkTrackVars="prop21,prop22,prop23,prop24";s_analytics.linkTrackEvents="None";s_analytics.currencyCode="USD";s_analytics.visitorNamespace="foxsports";s_analytics.trackingServer="a.fox.com";s_analytics.trackingServerSecure="b.fox.com";s_analytics.dc=122;s_analytics.siteID="yb"
s_analytics.defaultPage="section front"
s_analytics.queryVarsList=""
s_analytics.pathExcludeDelim=";"
s_analytics.pathConcatDelim=":"
s_analytics.pathExcludeList=""
s_analytics.pageLoad=0;var s_code='',s_objectID;function s_gi(un,pg,ss){var c="s.version='H.24.4';s.an=s_an;s.logDebug=function(m){var s=this,tcf=new Function('var e;try{console.log(\"'+s.rep(s.rep(m,\"\\n\",\"\\\\n\"),\""
...
try{(function(id,loader,u){try{u=utag.o[loader].sender[id]={}}catch(e){u=utag.sender[id]};u.ev={'view':1,'link':1,'video':1};u.o=s_analytics;u.pushlt=function(l,v){if(typeof l!="undefined")l.push(v)};u.map={};u.extend=[function(a,b){s_analytics.usePlugins=true
function s_doPlugins(s){if(!s_analytics.pageType&&!s_analytics.pageName)
{s_analytics.pageName=s_analytics.getPageName().toLowerCase();}
if((s_analytics.pageName.indexOf(':story:')>-1)&&!s_analytics.pageLoad)
{s_analytics.pageNameStop=s_analytics.pageName.lastIndexOf(':');s_analytics.pageName=s_analytics.pageName.slice(0,s_analytics.pageNameStop);s_analytics.pageName=s_analytics.pageName+':'+'detail story page';s_analytics.events=s_analytics.apl(s_analytics.events,"event46",",",2);s_analytics.pageLoad=1;}
s_analytics.prop75=document.URL;s_analytics.eVar75="D=c75";s_analytics.eVar2="D=pageName";s_analytics.serverStop=s_analytics.pageName.indexOf(':');s_analytics.channelStop=s_analytics.pageName.lastIndexOf(':');if(!s_analytics.server)
{s_analytics.server=s_analytics.pageName.slice(0,s_analytics.serverStop);}
if(!s_analytics.channel)
{s_analytics.channel=s_analytics.pageName.slice(0,s_analytics.channelStop);s_analytics.hier1="D=pageName";}
else
{s_analytics.hier1="D=pageName";}
...
{s_analytics.prop6=s_analytics.channelExtractCust(":",1,2,s_analytics.channel,1);s_analytics.eVar6="D=c6";}
if(!s_analytics.prop7)
{s_analytics.prop7=s_analytics.channelExtractCust(":",1,3,s_analytics.channel,1);s_analytics.eVar7="D=c7";}
if(!s_analytics.prop8)
{s_analytics.prop8=s_analytics.channelExtractCust(":",1,4,s_analytics.channel,1);s_analytics.eVar8="D=c8";}
if(!s_analytics.prop9)
{s_analytics.prop9=s_analytics.channelExtractCust(":",1,10,s_analytics.channel,1);s_analytics.eVar9="D=c9";}
if(!s_analytics.prop15&&typeof fsAlayticsPageType!="undefined")
{s_analytics.prop15=fsAnalyticsPageType.toLowerCase();s_analytics.eVar15="D=c15";}
s_analytics.hbx_lt="auto"
s_analytics.setupLinkTrack("prop21,prop22,prop23,prop24","SC_LINKS");s_analytics.linkTrackVars="prop21,prop22,prop23,prop24";s_analytics.linkTrackEvents="";s_analytics.downloadURL=s_analytics.downloadLinkHandler()
...
{s_analytics.eVar55="D=c55";if(s_analytics.prop55.toLowerCase()!="no sponsor")
{s_analytics.events=s_analytics.apl(s_analytics.events,'event82',',',2);}}
else
{s_analytics.prop55="no sponsor";s_analytics.eVar55="D=c55";}
if(s_analytics.prop1)
{s_analytics.prop1=s_analytics.getValOnce(s_analytics.prop1,'search_prop1',0);if(s_analytics.prop1)
{s_analytics.events=s_analytics.apl(s_analytics.events,"event1",",",2);s_analytics.eVar1='D=c1';s_analytics.prop4=s_analytics.getPreviousValue(s_analytics.pageName,'gpv_pageName','');s_analytics.eVar4="D=c4";}}
...
{s_analytics.prop67=s_analytics.getQueryParam('q');s_analytics.eVar67="D=c67";}
if(s_analytics.pageName.indexOf(':player:')>-1)
{s_analytics.prop54=s_analytics.getQueryParam('q');s_analytics.eVar54="D=c54";}
if(s_analytics.prop6&&!s_analytics.eVar6)s_analytics.eVar6="D=c6";if(s_analytics.prop7&&!s_analytics.eVar7)s_analytics.eVar7="D=c7";if(s_analytics.prop8&&!s_analytics.eVar8)s_analytics.eVar8="D=c8";if(s_analytics.prop9&&!s_analytics.eVar9)s_analytics.eVar9="D=c9";if(s_analytics.prop15&&!s_analytics.eVar15)s_analytics.eVar15="D=c15";if(s_analytics.prop35&&!s_analytics.eVar35)s_analytics.eVar35="D=c35";if(s_analytics.prop36&&!s_analytics.eVar36)s_analytics.eVar36="D=c36";if(s_analytics.prop37&&!s_analytics.eVar37)s_analytics.eVar37="D=c37";if(s_analytics.prop42&&!s_analytics.eVar43)s_analytics.eVar43="D=c42";if(s_analytics.prop16)
...
s_analytics.doPlugins=s_doPlugins}];u.send=function(a,b,c,d,e,f,g,h,ev,evt){if(u.ev[a]||typeof u.ev.all!="undefined"){utag.DB("send:6");b.sc_events=b.sc_events||{};u.addEvent=function(v){var t=[];if(v instanceof Array){t=v.slice(0);}else{t.push(v);}
...
try{utag.o[loader].loader.LOAD(id)}catch(e){utag.loader.LOAD(id)}})('6','foxsports.yardbarker');}catch(e){};