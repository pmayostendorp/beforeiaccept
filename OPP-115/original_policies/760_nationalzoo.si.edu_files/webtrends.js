...
// Created: 12/7/2010 5:10:27 PM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcsuft0skadzpxvkk977nydg5_3r1t";
	this.domain="logs1.smithsonian.museum";
	this.timezone=-5;
	this.fpcdom=".si.edu";
	this.onsitedoms="";
	this.downloadtypes="arc,arj,asx,avi,bin,com,dll,doc,docx,exe,gz,hqx,m4a,mp2,mp3,mpeg,pdf,ppt,pptx,rar,rpm,sit,tar,wav,wvx,xls,xlsx,z,zip,txt,csv";
