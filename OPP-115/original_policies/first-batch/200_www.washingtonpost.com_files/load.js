var pm_ppy="wwwwashingtonpost";var pm_geo="US";
 /** CJS **/ _pm_compute_pm_pgtp = function() {
    var page_url = document.URL;
    page_url = page_url ? page_url.toLowerCase() : page_url;
    return page_url.match(/_story\.html/) != null ? undefined : "blogPage";
}

var pm_pgtp = _pm_compute_pm_pgtp();
 /** CJS end **/ 
...
var _pmpmk = 'wwwwashingtonpost/pmk-201522005.24.js';
var _pmasync = true;
var _pmoptimization = true;
var _pmoptimizationmanipulation = true;
var _pmoptimizationmanipulationmode = 'hide,insert';
var _pmoptimizationpersonalizationdomains = 'www.thewrap.com, thewrap.com';
var _pmoptimizationinsertdomains = 'www.thewrap.com, thewrap.com';
var _pmsb = false;
