...
updated 07-19-2010: Added Search Center Code to config section; added 2 plugins: manageQueryParam v1.2 & clickThruQuality v1.0
...
if(!s.campaign) {
    s.campaign=s.getQueryParam('mbid,fb_ref')
