...
function s_doPlugins(s){
	...
	if (s.prop18 && s.prop19){
	    var makeModel = s.prop18 + " | " + s.prop19;
	    if (readCookie("MakeModelFirstMM") == null)
	        createCookie('MakeModelFirstMM', makeModel);
	    s.eVar20 = readCookie('MakeModelFirstMM'); // First View Make & Model
	    s.eVar21 = readCookie('MakeModelPreviousMM'); // Most Recent Make & Model
	    if (makeModel != readCookie('MakeModelPreviousMM'))
	        createCookie('MakeModelPreviousMM', makeModel);
	    s.eVar22 = s.prop18 + " | " + s.prop19; // Linear Make & Model
	}
