/* SiteCatalyst code version: H.23.8. Copyright 1996-2011 Adobe, Inc. All Rights Reserved (fo 2014-05-19)*/
var s_account="timefortunecom";
/* Dynamic account selection fix */
if(/(file:\/\/\/|localhost|dev-|cmbuild-|qa-|prodfix-|cp\.timeinc\.net|savvis\.net)/.test(location.href)){s_account="timefortunecomdev";}
...
s.linkInternalFilters="javascript:,timeinc.com,fortune.com,timeinc.net";
...
s.eVar2    = s.getQueryParam('pkw,iq_id');
s.eVar20=s.getQueryParam('link');
s.eVar22=s.getQueryParam('tcmid');
/*--- Begin Subs3 Campaigns ---*/
s.getQueryParam('fpa_adid') ?  s.fpa_adid = s.getQueryParam('fpa_adid') : s.fpa_adid = '';
s.getQueryParam('fpa_crid') ?  s.fpa_crid = s.getQueryParam('fpa_crid') : s.fpa_crid = '';
s.getQueryParam('fpa_ch') ?  s.fpa_ch = s.getQueryParam('fpa_ch') : s.fpa_ch = '';
s.getQueryParam('fpa_oc') ?  s.fpa_oc = s.getQueryParam('fpa_oc') : s.fpa_oc = '';
s.getQueryParam('fpa_siteName') ?  s.fpa_siteName = s.getQueryParam('fpa_siteName') : s.fpa_siteName = '';
s.getQueryParam('fpa_dartType') ?  s.fpa_dartType = s.getQueryParam('fpa_dartType') : s.fpa_dartType = '';
s.getQueryParam('fpa_dartPosition') ?  s.fpa_dartPosition = s.getQueryParam('fpa_dartPosition') : s.fpa_dartPosition = '';
s.fpa_str = s.fpa_adid+'|'+s.fpa_crid+'|'+s.fpa_ch+'|'+ s.fpa_oc+'|'+ s.fpa_siteName+'|'+ s.fpa_dartType+'|'+ s.fpa_dartPosition;
if ((s.fpa_adid =='0000')||(s.fpa_crid =='0000')) {s.eVar51 = ''}
else if(!/(^\|\|\|\|\|\|$)/.test(s.fpa_str)) {s.eVar51 = s.fpa_str};
/*--- End Subs3 Campaigns ---*/
}
s.doPlugins=s_doPlugins;
/*-------- Subs3 Page View w/o Page Refresh --------*/
function omniPage(desc){
...
s.trackingServer="metrics.fortune.com";
s.trackingServerSecure="smetrics.fortune.com";
